...
<style>
    ...
    .card {
        background-color: rgba(255, 255, 255, 0.95); /* biar teks tetap terbaca */
    }
</style>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="margin-top: 140px; background-color: transparent; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror text-black" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror text-black" name="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control text-whblackite" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
